/*
 *  Note - This has been customized to include special char validator
 *
	...
	"use strict";
		...
		var validators = {
				...
				length: {
						...
						message: function ( settings ) {
								return settings.length + " characters minimum";
						},
						preface: " "
                },
                special: {
		...
		$.extend(Plugin.prototype, {
				...
				wrapInput: function ( input ) {
						$('.password-messages').append( JST.input_wrapper() );
				...
				buildUi: function () {
						...
						_.each(this.settings.require, function ( requirement ) {
								...
								var preface = validators[requirement].preface || "One";
